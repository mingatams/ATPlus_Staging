trigger trLFGoalBeforeUpsertQOwner on LF_Goal__c (before insert, before update) {
...
// Making Queue the Owner Logic                                   
    ...
    if(ApplicationConstants.byPassLFGoalBeforeUpsertQOwner){                                    
    for (LF_Goal__c cd : trigger.new)                                   
    {                                   
