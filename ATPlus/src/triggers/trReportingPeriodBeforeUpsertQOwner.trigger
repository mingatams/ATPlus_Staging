trigger trReportingPeriodBeforeUpsertQOwner on Reporting_Period__c (before insert, before update) {
...
// Making Queue the Owner Logic                                   
    ...
    if(!ApplicationConstants.bypassReportingPeriodBeforeUpsertQOwner) {                                   
    for (Reporting_Period__c cd : trigger.new)                                   
    {                                   
